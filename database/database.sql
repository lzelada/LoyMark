...
/****** Object:  Database [LoyMark]    Script Date: 15/6/2023 20:51:46 ******/
CREATE DATABASE [LoyMark]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'LoyMark', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\LoyMark.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'LoyMark_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\LoyMark_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [LoyMark] SET RECOVERY FULL 
GO
